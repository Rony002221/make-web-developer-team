    ...
    return (
        <div>
            <div className="cart">
                ...
                <h6>Already Spend : <span class = "text-primary">$ {total}</span></h6> <hr />
                <button type="button" class="btn btn-primary btn-sm"><i class="fas fa-check"></i>   Submit </button>
                <br /><br /><br /><br />
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item list-group-item-success text-dark">{person.name} ({person.type}) </li>)}
                </ul>
